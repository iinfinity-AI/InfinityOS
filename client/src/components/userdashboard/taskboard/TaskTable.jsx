                    ...
                    <tr className="bg-indigo-50">
                      <td colSpan="8" className="px-6 py-4">
                        <div className="bg-white rounded-lg shadow-sm border border-indigo-100 p-4">
                          <h3 className="text-lg font-semibold text-indigo-800 mb-3 pb-2 border-b border-indigo-100">
                            {task.title}
                          </h3>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <p className="text-gray-700 whitespace-pre-line bg-gray-50 p-3 rounded-lg border border-gray-100">
                                  {task.description ||
                              ...
                              {task.statusNote && (
                                <div>
                                  ...
                                  <p className="text-gray-700 bg-yellow-50 p-2 rounded-lg border border-yellow-100 text-sm">
                                    {task.statusNote}
                                  </p>
                                </div>
                              )}
                            ...
                            <div className="space-y-4">
                              ...
                              {task.project && (
                                <div>
                                  ...
                                  <p className="text-gray-700 bg-purple-50 text-purple-800 text-sm inline-block px-2 py-0.5 rounded">
                                    {task.project}
                                  </p>
                                </div>
                              )}
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                      {task.attachments.map((attachment, i) => (
                                        <a
                                          ...
                                          className="flex items-center text-xs bg-white text-blue-700 hover:text-blue-900 hover:bg-blue-50 border border-blue-200 rounded-lg px-2 py-1 transition-colors"
                                        >
                                          <svg
                          ...
                          <div className="mt-6 pt-3 border-t border-gray-100 flex flex-wrap justify-between text-xs text-gray-500">
                            <div>
                              Created:{" "}
                              {task.createdAt
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-10 text-center">
        ...
        <p className="text-gray-500 max-w-md mx-auto">
          You don't have any assigned tasks at the moment. Tasks will appear
          here when they are assigned to you.
        </p>
      </div>
    );
  }
