...
const EmployeeDashboard = ({ tasks, loading, updatingId, handleStatusChange }) => (
...
const TeamLeadDashboard = ({ tasks, loading, updatingId, handleStatusChange }) => (
...
const UserDashboard = () => {
  ...
  // Get user role from localStorage (or context/store)
